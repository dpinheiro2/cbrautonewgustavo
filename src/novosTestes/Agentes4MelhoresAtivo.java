...
public class Agentes4MelhoresAtivo {
	...
	public HashMap<Integer, AgenteModelo> retornaHashDeAgentesParaAprender(){
		...
		AgenteModelo agente1 = new AgenteModelo("probabilidadechance", "probabilidadechance", "ativo", "yes", "nada", "ativo", 0.75, false, false);
		hashAgentes.put(1, agente1);
		
		AgenteModelo agente2 = new AgenteModelo("probabilidadechance", "probabilidadechance", "ativo", "no", "nada", "ativo", 0.75, false, false);
		hashAgentes.put(2, agente2);

		AgenteModelo agente4 = new AgenteModelo("chancesucesso", "chancesucesso", "ativo", "no", "nada", "ativo", 0.75, false, false);
		hashAgentes.put(3, agente4);

		AgenteModelo agente18 = new AgenteModelo("chancesucesso", "probabilidadechance", "ativo", "yes", "nada", "ativo", 0.75, false, false);
