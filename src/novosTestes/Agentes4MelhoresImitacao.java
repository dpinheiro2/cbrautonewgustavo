...
public class Agentes4MelhoresImitacao {
	...
	public HashMap<Integer, AgenteModelo> retornaHashDeAgentesParaAprender(){
		...
		AgenteModelo agente1 = new AgenteModelo("probabilidadechance", "probabilidadechance", "Nenhum", "yes", "nada", "imitacao", 0.75, false, true);
		hashAgentes.put(1, agente1);
		
		AgenteModelo agente2 = new AgenteModelo("probabilidadechance", "probabilidadechance", "Nenhum", "no", "nada", "imitacao", 0.75, false, true);
		hashAgentes.put(2, agente2);

		AgenteModelo agente4 = new AgenteModelo("chancesucesso", "chancesucesso", "Nenhum", "no", "nada", "imitacao", 0.75, false, true);
		hashAgentes.put(3, agente4);

		AgenteModelo agente18 = new AgenteModelo("chancesucesso", "probabilidadechance", "Nenhum", "yes", "nada", "imitacao", 0.75, false, true);
